...
public abstract class AbstractSingleNioChannel extends AbstractChannel {
    ...
    @Override
    public NioSingleEventLoop eventLoop() {
        return (NioSingleEventLoop) super.eventLoop();
    }
                ...
                if (doConnect(remoteAddress, localAddress)) {
                    ...
                    if (connectTimeoutMillis > 0) {
                        connectTimeoutFuture = eventLoop().schedule(new Runnable() {
                            @Override
                            public void run() {
                                ChannelPromise connectPromise = AbstractSingleNioChannel.this.connectPromise;
    ...
    protected boolean isCompatible(EventLoop loop) {
        return loop instanceof NioSingleEventLoop;
    }
